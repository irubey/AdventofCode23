...
# def reverse_num_words(number_words):
#     reverse_number_words = []
#     for word in number_words:
#         reverse_number_words.append(word[::-1])
#     return reverse_number_words

# reverse_number_words = reverse_num_words(number_words)


def replace_words_with_numbers(codes):
    replaced_codes = []
    for string in codes:
        for word, number in number_words.items():
            string = string.replace(word, str(number))
        replaced_codes.append(string)
    return replaced_codes

altered_codes = replace_words_with_numbers(codes)


def populate_numbers(codes):
    numbers = []
    for word in codes:
...
numbers = populate_numbers(altered_codes)       
